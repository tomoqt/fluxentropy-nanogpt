...
class DistributedDataLoader:
    def __init__(self, filename_pattern, T, process_rank, num_processes, num_bins=None, schedule_func=None, test_mode=False):
    ...
    def advance(self):
        self.current_shard = (self.current_shard + 1) % len(self.current_files)
        self.current_shard_file = self.current_files[self.current_shard]
...
class Hyperparameters:
    ...
    save_every : int = 0
    test_mode: bool = False  # Added for curriculum learning
