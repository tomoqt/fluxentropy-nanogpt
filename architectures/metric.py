...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        # Add metric signatures
        self.metric_signatures = nn.Parameter(torch.ones(self.n_head, self.head_dim))
    ...
    def forward(self, x, v1=None):
        ...
        # Apply metric signatures to keys
        binary_signatures = torch.tanh(self.metric_signatures)
        k = k * binary_signatures.view(1, 1, self.n_head, self.head_dim)
